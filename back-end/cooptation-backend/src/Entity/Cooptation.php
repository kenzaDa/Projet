...
class Cooptation
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Status::class, inversedBy="cooptations",cascade={"persist"}))
      * @Serializer\Groups({"cooptations"})
     */
    private $status;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=CooptedEntity::class, inversedBy="coopted_entity")
     * @Serializer\Groups({"cooptations"})
     */
